...
public class SineVelocityParticleModifier extends ParticleModifier {
    ...
    public void modify(Particle particle) {
        float vx = xAmplitude * MathUtils.sin(xNumCycles * (particle.getElapsed() - xHShift)) + xVShift;
        float vy = yAmplitude * MathUtils.sin(yNumCycles * (particle.getElapsed() - yHShift)) + yVShift;
