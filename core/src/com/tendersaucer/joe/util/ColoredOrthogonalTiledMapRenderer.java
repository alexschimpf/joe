...
public class ColoredOrthogonalTiledMapRenderer extends OrthogonalTiledMapRenderer {
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        ...
        for (int row = row2; row >= row1; row--) {
            ...
            for (int col = col1; col < col2; col++) {
                ...
                Color objectColor = batch.getColor();
                if (cellColorMap.containsKey(cell)) {
                    objectColor = cellColorMap.get(cell);
                }
                final float color = Color.toFloatBits(objectColor.r, objectColor.g, objectColor.b,
                        objectColor.a * layer.getOpacity());
    ...
    public void addCellColorMap(Map<TiledMapTileLayer.Cell, Color> cellColorMap) {
        this.cellColorMap.putAll(cellColorMap);
    }
}
